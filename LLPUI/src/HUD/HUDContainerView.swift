...
class HUDContainerView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        contentBackgroundView.snp.makeConstraints { make in
            make.width.lessThanOrEqualToSuperview().offset(-CGFloat.LLPUI.spacing10)
            make.height.lessThanOrEqualToSuperview().offset(-CGFloat.LLPUI.spacing10)
    ...
    private func updateBackground() {
        dimmingBackgroundView.alpha = isInteractionEnabled ? 0 : .LLPUI.dimmingAlpha
    }
