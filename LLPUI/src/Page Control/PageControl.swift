...
public class PageControl: UIControl {
    ...
    private lazy var cancelContinuousTapTimer = LLPUtils.Timer(interval: Constants.cancelContinuousTapInterval, isRepeated: false) { [weak self] in
    ...
    private var continuousPanSelectionTimer: LLPUtils.Timer?
