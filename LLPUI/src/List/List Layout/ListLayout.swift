...
class ListLayout: ListCollectionViewLayout {
    ...
    init(scrollDirection: UICollectionView.ScrollDirection) {
        ...
        self.register(ListSectionBackgroundDecorationView.self,
                      forDecorationViewOfKind: elementKindSectionBackground)
        self.register(ListSectionBackgroundDecorationView.self,
                      forDecorationViewOfKind: elementKindSectionInnerBackground)
        self.register(ListSectionConnectionDecorationView.self, forDecorationViewOfKind: elementKindSectionConnection)
    }
    ...
    override func prepare() {
        ...
        func frame(for itemRange: Range<Int>? = nil, in section: Int) -> CGRect? {
            ...
            guard numberOfItems > 0,
                  ...
                  let lastItem = layoutAttributesForItem(at: IndexPath(item: max(itemRange.startIndex, itemRange.endIndex - 1), section: section)) else {
                return nil
            }
    ...
    override func layoutAttributesForDecorationView(ofKind elementKind: String, at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        if elementKind == elementKindSectionBackground {
            return self.sectionBackgroundDecorationViewLayoutAttributes[section]
            
        } else if elementKind == elementKindSectionInnerBackground {
            return self.sectionInnerBackgroundDecorationViewLayoutAttributes[indexPath]
            
        } else if elementKind == elementKindSectionConnection {
            return self.sectionConnectionDecorationViewLayoutAttributes[section]
        }
