...
public class ButtonGroupFormComponent {
    ...
    public init(configurations: [ButtonConfiguration] = [], configurationTransformer: ButtonConfigurationTransforming? = nil, buttonSapcing: CGFloat = .LLPUI.spacing6, contentInset: Insets = .nondirectionalZero, width: CGFloat? = nil) {
