...
public class RangeSlider: UIControl {
    ...
    private func initialize() {
        ...
        lowerTextLabel.snp.makeConstraints { make in
            ...
            make.top.equalTo(layerLayoutGuide.snp.bottom).offset(CGFloat.LLPUI.spacing2)
        }
    ...
    private func updateAnimationEnabler() {
        ...
        [trackLayer, lowerThumbLayer, upperThumbLayer].forEach {
            $0.isAnimationEnabled = isAnimationEnabled
        }
    }
