...
public class EntityBadgeContainerView: UIView {
    ...
    public var entities: [Entity] = [] {
        didSet {
            ...
            if entities.count > maxDisplayCount {
                ...
                objects.append(ViewAllEntitiesViewModel(additionalCount: entities.count - maxDisplayCount, height: self.cancellable ? 22 : 14))
    ...
    private lazy var listBuilder: GenericListBuilder = {
        let configuration: GenericListBuilder.Configuration = .init { [weak self] index, sectionContext in
            ...
            .init(inset: .init(top: 0, left: .LLPUI.spacing1, bottom: 6, right: .LLPUI.spacing1))
