...
public extension CAAnimation {
    var completion: ((Bool) -> Void)? {
        get {
            if let delegate = self.delegate as? AnimationDelegate {
            ...
            if let delegate = self.delegate as? AnimationDelegate {
                ...
                self.delegate = AnimationDelegate(animation: self, completion: value)
            }
        }
    }
...
public extension CALayer {
    func makeAnimation(from: AnyObject? = nil, to: AnyObject, keyPath: String, timingFunction: AnimationTimingFunction = .easeInEaseOut, duration: Double, delay: Double = 0.0, removeOnCompletion: Bool = true, additive: Bool = false, completion: ((Bool) -> Void)? = nil) -> CAAnimation {
        ...
        case .caMediaTimingFunction(let function):
        ...
        case .spring:
            ...
            if !delay.isZero {
                animation.beginTime = self.convertTime(CACurrentMediaTime(), from: nil) + delay * CAAnimation.animationDurationFactor
            ...
            return animation
        case .customSpring(let damping, let initialVelocity):
    ...
    func animateAlpha(from: CGFloat? = nil, to: CGFloat, duration: Double, delay: Double = 0.0, timingFunction: AnimationTimingFunction = .easeInEaseOut, removeOnCompletion: Bool = true, completion: ((Bool) -> ())? = nil) {
        self.animate(from: from != nil ? NSNumber(value: Float(from!)) : nil, to: NSNumber(value: Float(to)), keyPath: "opacity", timingFunction: timingFunction, duration: duration, delay: delay, removeOnCompletion: removeOnCompletion, completion: completion)
    }
    ...
    func animateScale(from: CGFloat? = nil, to: CGFloat, duration: Double, delay: Double = 0.0, timingFunction: AnimationTimingFunction = .easeInEaseOut, removeOnCompletion: Bool = true, additive: Bool = false, completion: ((Bool) -> Void)? = nil) {
        self.animate(from: from != nil ? NSNumber(value: Float(from!)) : nil, to: NSNumber(value: Float(to)), keyPath: "transform.scale", timingFunction: timingFunction, duration: duration, delay: delay, removeOnCompletion: removeOnCompletion, additive: additive, completion: completion)
    }
    ...
    func animateScaleX(from: CGFloat? = nil, to: CGFloat, duration: Double, delay: Double = 0.0, timingFunction: AnimationTimingFunction = .easeInEaseOut, removeOnCompletion: Bool = true, completion: ((Bool) -> Void)? = nil) {
        self.animate(from: from != nil ? NSNumber(value: Float(from!)) : nil, to: NSNumber(value: Float(to)), keyPath: "transform.scale.x", timingFunction: timingFunction, duration: duration, delay: delay, removeOnCompletion: removeOnCompletion, completion: completion)
    }
    ...
    func animatePosition(from: CGPoint? = nil, to: CGPoint, duration: Double, delay: Double = 0.0, timingFunction: AnimationTimingFunction = .easeInEaseOut, removeOnCompletion: Bool = true, additive: Bool = false, force: Bool = false, completion: ((Bool) -> Void)? = nil) {
        ...
        self.animate(from: from != nil ? NSValue(cgPoint: from!) : nil, to: NSValue(cgPoint: to), keyPath: "position", timingFunction: timingFunction, duration: duration, delay: delay, removeOnCompletion: removeOnCompletion, additive: additive, completion: completion)
    }
    ...
    func animateBounds(from: CGRect? = nil, to: CGRect, duration: Double, delay: Double = 0.0, timingFunction: AnimationTimingFunction, removeOnCompletion: Bool = true, additive: Bool = false, force: Bool = false, completion: ((Bool) -> Void)? = nil) {
        ...
        self.animate(from: from != nil ? NSValue(cgRect: from!) : nil, to: NSValue(cgRect: to), keyPath: "bounds", timingFunction: timingFunction, duration: duration, delay: delay, removeOnCompletion: removeOnCompletion, additive: additive, completion: completion)
    }
    ...
    func animateWidth(from: CGFloat? = nil, to: CGFloat, duration: Double, delay: Double = 0.0, timingFunction: AnimationTimingFunction = .easeInEaseOut, removeOnCompletion: Bool = true, additive: Bool = false, force: Bool = false, completion: ((Bool) -> Void)? = nil) {
        ...
        self.animate(from: from != nil ? NSNumber(value: Float(from!)) : nil, to: to as NSNumber, keyPath: "bounds.size.width", timingFunction: timingFunction, duration: duration, delay: delay, removeOnCompletion: removeOnCompletion, additive: additive, completion: completion)
    }
    ...
    func animateHeight(from: CGFloat? = nil, to: CGFloat, duration: Double, delay: Double = 0.0, timingFunction: AnimationTimingFunction = .easeInEaseOut, removeOnCompletion: Bool = true, additive: Bool = false, force: Bool = false, completion: ((Bool) -> Void)? = nil) {
        ...
        self.animate(from: from != nil ? NSNumber(value: Float(from!)) : nil, to: to as NSNumber, keyPath: "bounds.size.height", timingFunction: timingFunction, duration: duration, delay: delay, removeOnCompletion: removeOnCompletion, additive: additive, completion: completion)
    }
    ...
    func animateBoundsOriginXAdditive(from: CGFloat? = nil, to: CGFloat, duration: Double, timingFunction: AnimationTimingFunction = .easeInEaseOut, removeOnCompletion: Bool = true, completion: ((Bool) -> Void)? = nil) {
        self.animate(from: from != nil ? NSNumber(value: Float(from!)) : nil, to: to as NSNumber, keyPath: "bounds.origin.x", timingFunction: timingFunction, duration: duration, removeOnCompletion: removeOnCompletion, additive: true, completion: completion)
    }
    ...
    func animateBoundsOriginYAdditive(from: CGFloat? = nil, to: CGFloat, duration: Double, timingFunction: AnimationTimingFunction = .easeInEaseOut, removeOnCompletion: Bool = true, completion: ((Bool) -> Void)? = nil) {
        self.animate(from: from != nil ? NSNumber(value: Float(from!)) : nil, to: to as NSNumber, keyPath: "bounds.origin.y", timingFunction: timingFunction, duration: duration, removeOnCompletion: removeOnCompletion, additive: true, completion: completion)
    }
    
    func animatePositionKeyframes(values: [CGPoint], duration: Double, removeOnCompletion: Bool = true, completion: ((Bool) -> Void)? = nil) {
        self.animateKeyframes(values: values.map { NSValue(cgPoint: $0) }, duration: duration, keyPath: "position", removeOnCompletion: removeOnCompletion, completion: completion)
    }
    ...
    func animateFrame(from: CGRect? = nil, to: CGRect, duration: Double, delay: Double = 0.0, timingFunction: AnimationTimingFunction = .easeInEaseOut, removeOnCompletion: Bool = true, additive: Bool = false, force: Bool = false, completion: ((Bool) -> Void)? = nil) {
        ...
        self.animatePosition(from: fromPosition, to: toPosition, duration: duration, delay: delay, timingFunction: timingFunction, removeOnCompletion: removeOnCompletion, additive: additive, force: force, completion: { value in
            if !value {
                interrupted = true
            }
        ...
        self.animateBounds(from: fromBounds, to: toBounds, duration: duration, delay: delay, timingFunction: timingFunction, removeOnCompletion: removeOnCompletion, additive: additive, force: force, completion: { value in
            if !value {
                interrupted = true
            }
