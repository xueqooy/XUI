...
public class TimePickerField: Field {
    ...
    public override var validationState: ValidationState {
        didSet {
    ...
    public override var defaultContentHeight: CGFloat { 40 }
    ...
    public override func makeContentView() -> UIView {
        ...
        return HStackView {
            ...
            HSpacerView(.LLPUI.spacing3, compressionResistancePriority: .required)
