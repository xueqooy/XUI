...
class BarChartLegendGroupView: UIView {
    ...
    private static let insets: UIEdgeInsets = .init(uniformValue: .LLPUI.spacing2)
    private static let minimumInteritemSpacing: CGFloat = .LLPUI.spacing3
    ...
    override init(frame: CGRect) {
        ...
        flowLayout.minimumLineSpacing = .LLPUI.spacing1
...
private class LegendCell: UICollectionViewCell {
    ...
    static private let imageSize: CGSize = .square(12)
    static private let imageToLabelSpacing: CGFloat = .LLPUI.spacing1
    static private let labelFont = Fonts.caption
