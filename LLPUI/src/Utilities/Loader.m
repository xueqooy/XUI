...
+ (void)load_uiviewController_viewstate {
    ...
    SEL sel = @selector(LLPUI_load_uiviewController_viewstate);
...
+ (void)load_uiviewController_viewsizetransition {
    #pragma clang diagnostic push
    #pragma clang diagnostic ignored "-Wundeclared-selector"
    SEL sel = @selector(LLPUI_load_uiviewController_viewsizetransition);
    #pragma clang diagnostic pop
...
+ (void)load_uicontrol_selectable {
    #pragma clang diagnostic push
    #pragma clang diagnostic ignored "-Wundeclared-selector"
    SEL sel = @selector(LLPUI_load_uicontrol_selectable);
    #pragma clang diagnostic pop
...
+ (void)load_uibaritem_viewhook {
    #pragma clang diagnostic push
    #pragma clang diagnostic ignored "-Wundeclared-selector"
    SEL sel = @selector(LLPUI_load_uibaritem_viewhook);
    #pragma clang diagnostic pop
