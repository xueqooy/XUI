...
class DropdownMenuContentView: UIView {
    private static let customSpacingAfterTitle: CGFloat = .XUI.spacing2
    ...
    private lazy var listBuilder: GenericListBuilder = .init(configuration: .single(of: DropdownMenuCell.self) { [weak self] cell, sectionContext in
