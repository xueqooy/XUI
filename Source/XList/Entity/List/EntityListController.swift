...
public class EntityListController: UIViewController {
    ...
    private lazy var listBuilder: GenericListBuilder = .init(configuration: .init(cellTypeProvider: { _, sectionContext in
    ...
    }, itemDidDeselectHandler: { [weak self] _, sectionContext in
    ...
    override public func viewDidLoad() {
        ...
        view.addForm(scrollingBehavior: .disabled) { formView in
            formView.itemSpacing = .XUI.spacing7
    ...
    private func resolveSelectionForMultiSelect() {
        ...
        for identifier in identifiersForSelectedEntities {
