    ...
    @MainActor public var viewController: UIViewController? {
        set {
            ...
            viewSizeTransitionCancellable = newValue?.viewWillTransitionToSizePublisher
                .sink(receiveValue: { [weak self] _, coordinator in
...
extension ListController: ListAdapterDataSource {
    @MainActor public func objects(for _: ListAdapter) -> [ListDiffable] {
        var result = objects
    ...
    @MainActor public func emptyView(for _: ListAdapter) -> UIView? {
        emptyView
    }

    public func listAdapter(_: ListAdapter, sectionControllerFor object: Any) -> ListSectionController {
        switch object {
        case is ListSpinner:
...
extension ListController: @preconcurrency ListAdapterMoveDelegate {
    @MainActor public func listAdapter(_: ListAdapter, move _: Any, from _: [Any], to objects: [Any]) {
