...
public final class GenericListBuilder: ListBuilder {
    public typealias AutoDimensionObject = ListCellSizeCacheIdentifiable & Object
...
extension GenericListBuilder: _GenericSectionControllerDataSource {
    func sectionController(_ sectionController: _GenericSectionController, numberOfItemsFor _: Any) -> Int {
    ...
    func sectionController(_ sectionController: _GenericSectionController, sizeForItemAt index: Int) -> CGSize {
        ...
        return sectionController.managedCellSize(of: automaticDimensionCellType, for: automaticDimensionObject) { cell, _ in
