...
/**
 ...
 ```
  */
public final class BindingListBuilder: NSObject, ListBuilder {
    ...
    public typealias AutomaticDimensionBindingCell = BindingCell & ListCellSizeProviding
...
extension BindingListBuilder: ListBindingSectionControllerDataSource {
    public func sectionController(_ sectionController: ListBindingSectionController<ListDiffable>, viewModelsFor _: Any) -> [ListDiffable] {
    ...
    public func sectionController(_ sectionController: ListBindingSectionController<ListDiffable>, cellForViewModel _: Any, at index: Int) -> UICollectionViewCell & ListBindable {
        let sectionContext = (sectionController as! _BindingSectionController).context
...
extension BindingListBuilder: ListBindingSectionControllerSelectionDelegate {
    public func sectionController(_ sectionController: ListBindingSectionController<ListDiffable>, didSelectItemAt index: Int, viewModel _: Any) {
        let sectionContext = (sectionController as! _BindingSectionController).context

        configuration.itemDidSelectHandler?(index, sectionContext)
    }

    public func sectionController(_ sectionController: ListBindingSectionController<ListDiffable>, didDeselectItemAt index: Int, viewModel _: Any) {
        let sectionContext = (sectionController as! _BindingSectionController).context

        configuration.itemDidDeselectHandler?(index, sectionContext)
    }

    public func sectionController(_: ListBindingSectionController<ListDiffable>, didHighlightItemAt _: Int, viewModel _: Any) {}

    public func sectionController(_: ListBindingSectionController<ListDiffable>, didUnhighlightItemAt _: Int, viewModel _: Any) {}
}
