...
open class Popover: Configurable {
    ...
    public struct Configuration {
        ...
        public var background: BackgroundConfiguration = .overlay(color: .white, cornerStyle: .fixed(.XUI.smallCornerRadius))
        public var preferredDirection: Direction = .down
        public var contentInsets: UIEdgeInsets = .init(uniformValue: .XUI.spacing4)
        public var superviewMargins: UIEdgeInsets = .init(uniformValue: .XUI.spacing4)
        public var offset: CGPoint = .zero
        public var arrowSize: CGSize = .init(width: 16, height: 10)
        ...
        public init(dismissMode: DismissMode = .none,
                    background: BackgroundConfiguration = .overlay(color: .white, cornerStyle: .fixed(.XUI.smallCornerRadius)),
                    preferredDirection: Direction = .down,
                    contentInsets: UIEdgeInsets = .init(uniformValue: .XUI.spacing4),
                    superviewMargins: UIEdgeInsets = .init(uniformValue: .XUI.spacing4),
                    offset: CGPoint = .zero,
