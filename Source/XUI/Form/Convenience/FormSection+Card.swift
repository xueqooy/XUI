...
public extension FormSection {
    static func card(contentInset: Insets = .directional(uniformValue: .XUI.spacing5), itemSpacing: CGFloat = 0, automaticallyUpdatesVisibility: Bool = true, @ArrayBuilder<FormComponent> components: () -> [FormComponent]) -> FormSection {
