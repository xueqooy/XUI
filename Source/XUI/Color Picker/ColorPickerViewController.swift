...
class ColorPickerViewController: UIViewController {
    ...
    private static let formRowSpacing: CGFloat = .XUI.spacing7

    private static var maximumColumns = 5

    private static let itemSize = CGSize(width: 57, height: 57)

    private static let minimumLineSpacing: CGFloat = .XUI.spacing4
    ...
    var selectedColor: UIColor? {
        didSet {
            if shouldShowConfirmationButton {
                confirmationButton.isEnabled = selectedColor != nil
            }
        }
    }
