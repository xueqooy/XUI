...
class SketchDrawingView: UIView {
    ...
    override public func layoutSublayers(of layer: CALayer) {
        ...
        for updatedBaseNode in updatedBaseNodes {
            updatedBaseNode.updateBoundingSize(boundingSize)
        }
        for updatedNextNode in updatedNextNodes {
            updatedNextNode.updateBoundingSize(boundingSize)
        }
