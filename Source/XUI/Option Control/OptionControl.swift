...
public class OptionControl: UIControl {
    private enum Constants {
        static let componentSpacing: CGFloat = .XUI.spacing3
...
//        label.settingContentCompressionResistanceAndHuggingPriority(.required, for: .horizontal)
    ...
    private lazy var flexibleSpacer: HSpacerView = .init(Constants.componentSpacing, compressionResistancePriority: .defaultHigh)
