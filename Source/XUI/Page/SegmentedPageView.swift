...
open class SegmentedPageView: PageView {
    ...
    private(set) lazy var segmentControl: SegmentControl = {
        ...
        segmentControl.selectionChanged = { [weak self] control in
            ...
            guard control.selectedSegmentIndex != .XUI.noSelection, control.selectedSegmentIndex != self.selectedPageIndex else {
                return
            }
    ...
    override public func selectPage(at index: Int, animated: Bool) {
...
public extension SegmentedPageView {
