...
open class PersonaView: UIView, Configurable {
    public struct Layout {
        ...
        public init(
            ...
            avatarPadding: CGFloat = .XUI.spacing4,
            titlePadding: CGFloat = .XUI.spacing1
        ) {
    ...
    public struct Configuration: Equatable, Then {
        ...
        public init(
            ...
            attributedTitle _: NSAttributedString? = nil,
            richTitle: RichText? = nil,
            numberOfTileLines _: Int = 1,
            subtitle: String? = nil,
            subtitleStyle: TextStyleConfiguration? = .personaSubtitle,
            attributedSubtitle _: NSAttributedString? = nil,
            richSubtitle: RichText? = nil,
            numberOfSubtileLines _: Int = 1
        ) {
