...
public class DrawerController: UIViewController {
    private enum Constants {
        ...
        static let contentInsets = UIEdgeInsets(top: .XUI.spacing5, left: .XUI.spacing5, bottom: .XUI.spacing5, right: .XUI.spacing5)
    }
...
extension DrawerController: DrawerPresentationControllerDelegate {
    func drawerPresentationControllerDismissalRequested(_: DrawerPresentationController) {
        dismissPresentingViewController(animated: true)
    }

    func drawerPrsentationControllerPresentedViewMaskUpdateRequested(_: DrawerPresentationController, expectedMaskedCorners: CACornerMask) {
