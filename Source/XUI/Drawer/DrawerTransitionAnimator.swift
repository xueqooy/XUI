...
class DrawerTransitionAnimator: NSObject {
    ...
    static func sizeChange(forPresentedView presentedView: UIView, presentationDirection: Direction) -> CGFloat {
    ...
    init(presenting: Bool, presentationDirection: Direction) {
