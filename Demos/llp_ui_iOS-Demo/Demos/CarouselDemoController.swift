...
class CarouselDemoController: DemoController {
    override func viewDidLoad() {
        ...
        if Device.current.isPad {
            flexibleCarouselView.contentSize = .init(width: 350, height: .LLPUI.automaticDimension)
        } else {
            flexibleCarouselView.contentSize = .square(.LLPUI.automaticDimension) // Default
        }
