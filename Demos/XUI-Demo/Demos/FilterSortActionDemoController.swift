...
private class FilterOptionsView: BindingView {
    ...
    private let clearButton = XUI.Button(designStyle: .borderless, title: "Clear")
    ...
    private let applyButton = XUI.Button(designStyle: .primary, contentInsetsMode: .ignoreHorizontal, title: "Apply")
