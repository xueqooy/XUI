//
//  FocusCollectionViewLayout.swift
//  Pods
//
...
open class SnapToCenterCollectionViewLayout: UICollectionViewLayout, FocusedContaining {
    ...
    internal var actualSectionInsetLeft: CGFloat = 0
    ...
    internal var actualSectionInsetRight: CGFloat = 0
    ...
    override open var collectionViewContentSize: CGSize {
        ...
        let h: CGFloat = CGFloat(headerHeight ?? 0.0) + sectionInset.top + sectionInset.bottom + itemSize.height + CGFloat(footerHeight ?? 0.0)
