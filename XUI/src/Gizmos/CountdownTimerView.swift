...
public class CountdownTimerView: UIView {
    ...
    public var title: String? {
        didSet {
            ...
            if (title ?? "").isEmpty {
                ...
                hourglassImageView.settingCustomSpacingAfter(.XUI.spacing2)
                
            } else {
                titleLabel.isHidden = false
                hourglassImageView.settingCustomSpacingAfter(.XUI.spacing1)
            }
        }
    }
    ...
    private lazy var progressStackView = VStackView(spacing: .XUI.spacing1) {
        timeLabel
    ...
    public init(title: String? = nil, totalSeconds: Int) {
        ...
        let stackView = HStackView(alignment: .center) {
            hourglassImageView
                .settingCustomSpacingAfter(.XUI.spacing2)
